= Vision: {project-name}
Tilman Ischner <tilman.ischner@htw-dresden.de>; Vorname2 Nachname2 <email2@domain.org>; Vorname3 Nachname3 <email3@domain.org>
{localdatetime}
...
Ein Barbetreiber möchte einen Online-Shop für den Versand individualisierter Cocktails zusätzlich zu seinem Barbetrieb aufbauen
...
[cols="1,3"]
|===
|Das Problem |	Besucher der Bar möchten selbst zusammengestellte Cocktails nach Hause bestellen
|betrifft |	den Barbetreiber
|die Auswirkung davon ist | geringer Reichweite der Bar
|eine erfolgreiche Lösung wäre |	Online-Shop für den Versand individualisierter Cocktails
|===
...
|===
|Für|	Zielkunde
|der / die|	individualisierte Cocktails für besondere Anlässe bestellen möchte
|Das Produkt / die Lösung ist ein | Online-Shop
|Die / Das	| Cocktails nach Hause liefert
|Im Gegensatz zu	| konventionellen Cocktails in einer ar
|Unser Produkt|	versendet auch selbst zusammengestellte Cocktails zum Kunden
|===
...
|Barbetreiber	|betreibt Bar und erteilt Auftrag	| bearbeitet Bestellungen
|Kunde	|über Kundenkonto verwalteter Kunde	| gibt Bestellungen auf
|Gesetzgeber	|externe nicht am Kaufprozess beteiligte Instanz	| gibt Richtlinien vor
|IT-Betrieb	||
